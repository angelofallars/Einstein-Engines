...
public sealed partial class TraitStatModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<StamcritModifierComponent, ComponentStartup>(OnStamcritStartup);
    ...
    private void OnStamcritStartup(EntityUid uid, StamcritModifierComponent component, ComponentStartup args)
    {
