...
public sealed partial class TraitStatModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<StaminaThresholdModifierComponent, ComponentStartup>(OnStamcritStartup);
    ...
    private void OnStamcritStartup(EntityUid uid, StaminaThresholdModifierComponent component, ComponentStartup args)
    {
